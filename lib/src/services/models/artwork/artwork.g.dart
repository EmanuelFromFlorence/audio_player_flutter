...
Serializer<Artwork> _$artworkSerializer = new _$ArtworkSerializer();

class _$ArtworkSerializer implements StructuredSerializer<Artwork> {
  @override
  final Iterable<Type> types = const [Artwork, _$Artwork];
  @override
  final String wireName = 'Artwork';

  @override
  Iterable<Object> serialize(Serializers serializers, Artwork object,
  ...
  @override
  Artwork deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ArtworkBuilder();
...
class _$Artwork extends Artwork {
  @override
  final String bucket;
  @override
  ...
  factory _$Artwork([void Function(ArtworkBuilder) updates]) =>
      (new ArtworkBuilder()..update(updates)).build();
  ...
  _$Artwork._(
      ...
      : super._() {
    if (bucket == null) {
      throw new BuiltValueNullFieldError('Artwork', 'bucket');
    }
    if (contentDisposition == null) {
      throw new BuiltValueNullFieldError('Artwork', 'contentDisposition');
    }
    if (contentEncoding == null) {
      throw new BuiltValueNullFieldError('Artwork', 'contentEncoding');
    }
    if (contentType == null) {
      throw new BuiltValueNullFieldError('Artwork', 'contentType');
    }
    if (crc32c == null) {
      throw new BuiltValueNullFieldError('Artwork', 'crc32c');
    }
    if (downloadTokens == null) {
      throw new BuiltValueNullFieldError('Artwork', 'downloadTokens');
    }
    if (etag == null) {
      throw new BuiltValueNullFieldError('Artwork', 'etag');
    }
    if (generation == null) {
      throw new BuiltValueNullFieldError('Artwork', 'generation');
    }
    if (md5Hash == null) {
      throw new BuiltValueNullFieldError('Artwork', 'md5Hash');
    }
    if (metageneration == null) {
      throw new BuiltValueNullFieldError('Artwork', 'metageneration');
    }
    if (name == null) {
      throw new BuiltValueNullFieldError('Artwork', 'name');
    }
    if (size == null) {
      throw new BuiltValueNullFieldError('Artwork', 'size');
    }
    if (storageClass == null) {
      throw new BuiltValueNullFieldError('Artwork', 'storageClass');
    }
    if (timeCreated == null) {
      throw new BuiltValueNullFieldError('Artwork', 'timeCreated');
    }
    if (updated == null) {
      throw new BuiltValueNullFieldError('Artwork', 'updated');
    }
  }

  @override
  Artwork rebuild(void Function(ArtworkBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ArtworkBuilder toBuilder() => new ArtworkBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Artwork')
          ..add('bucket', bucket)
...
class ArtworkBuilder implements Builder<Artwork, ArtworkBuilder> {
  _$Artwork _$v;
  ...
  @override
  void replace(Artwork other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$Artwork;
  }

  @override
  void update(void Function(ArtworkBuilder) updates) {
